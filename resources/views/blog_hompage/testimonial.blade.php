    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="{{ route('user./.blog_starting_home_allpost') }}" class="nav-link nav-item">Blog</a>
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="{{ route('user./.blog_starting_home_feature_page') }}" class="dropdown-item ">Our
                            features</a>
    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                ...
                <a href="{{route('user./.blog_starting_home_team_page')}}" class="h5 text-white">Testimonial</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row gx-5">
            <div class="col-lg-4 col-md-6 footer-about">
                <div
                    ...
                    <p class="mt-3 mb-4">Lorem diam sit erat dolor elitr et, diam lorem justo amet clita
                        stet
