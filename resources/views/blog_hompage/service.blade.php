    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="{{ route('user./.blog_starting_home_service_page') }}" class="nav-item nav-link  active">Services</a>
    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                ...
                <a href="{{route('user./.blog_starting_home_service_page')}}" class="h5 text-white">Services</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                <div
                    ...
                    <p class="text-white mb-3">Clita ipsum magna kasd rebum at ipsum amet dolor justo dolor est magna
                        stet eirmod</p>
                    <h2 class="text-white mb-0">8695166945</h2>
                </div>
            </div>
        </div>
    </div>
