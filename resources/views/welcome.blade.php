                    ...
                    @if (Route::has('login'))
                        ...
                        @auth
                            ...
                            @elseif(Auth::user()->role_id == 2)
                                <a href="{{ route('user./.blog_starting_home_page') }}">Dashboard</a>
                            @else
                                null
                            @endif
                        @else
            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div
                    ...
                    <p class="mt-3 mb-4">Lorem diam sit erat dolor elitr et, diam lorem justo amet clita stet eos
                        user. sit. Elitr dolor duo lorem, elitr clita ipsum sea. Diam amet erat lorem stet eos. Diam
                        amet et
                        kasd eos duo.</p>
                    <form action="">
                        user. <div class="input-group">
                            <input type="text" class="form-control border-white p-3" placeholder="Your Email">
                            user. <button class="btn btn-dark">Sign Up</button>
                        </div>
                        user. </form>
                </div>
            </div>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        ...
                        <div class="d-flex mb-2">
                            ...
                            <p class="mb-0">123 Street, Banglore, India</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-envelope-open text-primary me-2"></i>
                            <p class="mb-0">kumaran@qoruz.com</p>
                        </div>
                        <div class="d-flex mb-2">
                            <i class="bi bi-telephone text-primary me-2"></i>
                            <p class="mb-0">8695966945</p>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            ...
                            <a class="text-light mb-2" href="{{ route('user./.blog_starting_home_team_page') }}"><i
                                    class="bi bi-arrow-right text-primauser.ry me-2"></i>Meet The Team</a>
                            <a class="text-light mb-2" href="{{ route('user./.blog_starting_home_allpost') }}"><i
                                    class="bi bi-arrow-right text-primauser.ry me-2"></i>Latest Blog</a>
                            <a class="text-light"
                                href="{{ route('user./.blog_starting_home_contact_page') }}"><i user.
