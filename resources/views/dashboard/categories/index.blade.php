    ...
    <header class="bg-white shadow">
        <div class="flex px-4 py-6 mx-auto space-x-8 max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="space-x-4">
                ...
                <a class="inline-flex items-center px-1 pt-1 text-sm text-decoration-underline font-medium leading-5 text-gray-900 transition"
                    href="{{ route('admin.categories.index') }}">
                    Index
                </a>


                <a class="inline-flex items-center px-1 pt-1 text-sm font-medium leading-5 text-gray-500  transition"
